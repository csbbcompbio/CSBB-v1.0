...
pdf(outfile1)
heatmap.2(data, scale = "row", col = hmcols, Rowv = FALSE, Colv = TRUE, show_grid=FALSE, na.rm = TRUE, cellnote_scale = TRUE, cexRow = 0.5, trace = "none", density.info = c("histogram","density","none"))
